...
package 
{
	...
	public class HostInfoWindow extends NativeWindow 
	{
		
		private var _htmlLoader:HTMLLoader;
		private var _initialized:Boolean = false;
		private var _contentHTML:String = null;
		private var vSb:UIScrollBar = new UIScrollBar();
		private var hSb:UIScrollBar = new UIScrollBar();
		private var padding:Number = 0;
		private static var _activeInstance:HostInfoWindow=null;
		
		public function HostInfoWindow(initOptions:NativeWindowInitOptions, contentHTML:String, widthVal:Number, heightVal:Number) 
		{	
			super(initOptions);
			this.width = widthVal;
			...
			if (_activeInstance == null) {
				...
				trace ("New HostInfoWindow created");
			} else {
		...
		public function load(contentHTML:String):void {
			...
			this._htmlLoader.placeLoadStringContentInApplicationSandbox = true;
			this.stage.addChild(this._htmlLoader);
			this._htmlLoader.loadString(_contentHTML);				
		...
		public function initialize(eventObj:Event):void {
			trace ("HostInfoWindow initialized...");
			trace ("Dims: " + this.width + "x" + this.height);
